...
// todo: если сервер с кликом умрёт, то мы потеряем все тики с последнего бакапа сервера
// нужно сделать так, что бы майнер хранил буки за последние несколько дней,
// что бы в случае факапа - мы могли "проиграть" последние буки
// bonus: начать зиповать
